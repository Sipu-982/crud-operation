        ...
        <tbody>
        
          {
           ...
           return <tr key={users.ID}>
              ...
              <td>{users.age}</td>
              <td>
                <Link to={`/updateuser/${users._id}`} className='mr-2 py-2 px-6 bg-red-500 text-white rounded-md shadow-md shadow-neutral-300 home-btn'>Update</Link>
                <button className='cursor-pointer py-2 px-6 bg-blue-500 text-white rounded-md shadow-md shadow-neutral-300 home-btn' onClick={(e)=>handleDelete(users._id)}>Delete</button>
              </td>
            </tr>
            })
          }
